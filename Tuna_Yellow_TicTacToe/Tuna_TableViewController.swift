//
//  Tuna_TableViewController.swift
...
class Tuna_TableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        let numberOfGamesPlayed = UserDefaults.standard.integer(forKey: "numberOfGamePlayed");
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "tuna_table_cell", for: indexPath) as! Tuna_TableViewCell
